...
public interface MdService {
     ...
     * @return
     */
    UserInfo login(String username, String pwd, boolean withAuthorization) throws Exception;
    ...
    List<KnowledgePoint> getKnowledgePointsByCourseId(Integer courseId, Integer depth);
    //endregion

    List<CatalogKPointMap> getCatalogKPointMappings(Integer courseId);
     ...
     * @return
     */
    Map<Integer, String> getTopLevelKnowledgePoints(int courseId);
